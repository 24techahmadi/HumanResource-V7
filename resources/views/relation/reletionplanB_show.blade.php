...
<div id="main">
    ...
    <div class="wrapper">
        ...
        <!--breadcrumbs end-->
        @section('content')
            <h1 class="header" align="right">پلان ب</h1>
            ...
            <div class="row">
                <div class="col s12 m12 l12">
                    <div class="card-panel">
                        ...
                        <hr>
                        <div class="row">
                            <form method="POST" action="{{ url('relationplanB') }}" class="col s12" >
                                {!! csrf_field() !!}
                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="input-field col s6">
                                            ...
                                            <label for="DepartmentsName">دیپارتمنت جدید</label>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="card-panel">
                                        ...
                                        <hr>
                                        <div class="row">
                                            <form method="POST" action="{{ route('relationplanB.update',['id'=>$record]) }}" accept-charset="utf-8" class="col s11 right" data-parsley-validate>
                                                {!! csrf_field() !!}
