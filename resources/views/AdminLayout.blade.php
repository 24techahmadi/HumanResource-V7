              ...
              <li class="user-details cyan darken-2">
                  <div class="row">
                      <div id="user-pic" class="col col s4 m4 l4">
                          <img src="{{ URL::asset('assets/images/AF.png') }}" alt="" class="circle responsive-img valign profile-image">
                      </div>
                  ...
                  <div class="col col s8 m8 l8">
                          <ul id="profile-dropdown" class="dropdown-content">
                           ...
                           <a class="btn-flat dropdown-button waves-effect waves-light white-text profile-btn" href="#" data-activates="profile-dropdown">Development Office<i class="mdi-navigation-arrow-drop-down right"></i></a>
                          <p class="user-roal">Admin</p>
                      </div> 
              </li>

              
               <li class="bold"><a href="{{ URL::to('development') }}" class="waves-effect waves-cyan"><i class="mdi-action-dashboard"></i> Dashboard</a>
              </li>

              <li class="no-padding">
                  <ul class="collapsible collapsible-accordion">

                      <li class="bold"><a class="collapsible-header  waves-effect waves-cyan"><i class="mdi-editor-border-all"></i>ManageUsers</a>
                          <div class="collapsible-body">
                              <ul>
                                  <li><a href="{{  URL::to('admin/users/create') }}">Create</a>
                                  </li>
                                  <li><a href="{{ URL::to('admin/users') }}">UsersList</a>
                                  </li>
