              ...
              <li class="user-details cyan darken-2">
                  <div class="row">
                      <div id="user-pic" class="col col s4 m4 l4">
                          <img src="{{ URL::asset('assets/images/Atiq..png') }}" alt="" class="circle responsive-img valign profile-image">
                      </div>
                  ...
                  <div class="col col s8 m8 l8">
                          <ul id="profile-dropdown" class="dropdown-content">
                           ...
                           <a class="btn-flat dropdown-button waves-effect waves-light white-text profile-btn" href="#" data-activates="profile-dropdown">مدیریت انکشاف اداره<i class="mdi-navigation-arrow-drop-down right"></i></a>
                          
                      </div> 
              </li>
 
              
               <li class="bold"><a href="{{ URL::to('dev') }}" class="waves-effect waves-cyan"><i class="mdi-action-dashboard"></i> دشبورد</a>
              </li>
                  ...
                  <ul class="collapsible collapsible-accordion" >
                      <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-action-invert-colors"></i>پلان ها</a>
                          <div class="collapsible-body">
                              <ul>
                                  <li><a href="{{ URL::to('devplanA') }}">پلان الف</a>
                                  </li>
                                  <li><a href="{{ URL::to('devplanB') }}">پلان ب</a>
                                  </li>
                                  <li><a href="{{ URL::to('devplanC') }}">پلان ج</a>
                                  </li>
                              </ul>
                          </div>
                      </li> <li> </li>

                      <li class="bold"><a href="{{ URL::to('bast') }}" class="waves-effect waves-cyan"><i class="mdi-editor-insert-invitation"></i>ایجاد بست جدید</a>
                      </li>


                      <li class="bold"><a href="{{ URL::to('comparison') }}" class="collapsible-header waves-effect waves-cyan"><i class="mdi-editor-insert-chart"></i>فورم مقایسوی</a>

                      </li>

                      <li class="bold"><a href="{{ URL::to('plan') }}" class="collapsible-header  waves-effect waves-cyan"><i class="mdi-action-swap-vert-circle"></i>پلان کارمندان</a>

                      </li>

                      <li class="bold"><a href="{{ URL::to('devreport') }}" class="collapsible-header  waves-effect waves-cyan"><i class="mdi-editor-insert-invitation"></i>گذارشات</a>
