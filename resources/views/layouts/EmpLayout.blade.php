...
<a class="btn-flat dropdown-button waves-effect waves-light white-text profile-btn" href="#" data-activates="profile-dropdown">مدیریت استخدام کارکنان<i class="mdi-navigation-arrow-drop-down right" ></i></a>
                      </div> 
              </li>


              <li class="bold"><a href="{{ URL::to('employment') }}" class="waves-effect waves-cyan"><i class="mdi-action-dashboard" style="font-size: 30"></i>دشبورد</a>
              </li>
                  ...
                  <ul class="collapsible collapsible-accordion">
                      <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-action-invert-colors"></i> پلان ها</a>
                          <div class="collapsible-body">
                              <ul>
                                  <li><a href="{{ URL::to('empplanA') }}">پلان الف</a>
                                  </li>
                                  <li><a href="{{ URL::to('empplanB') }}">پلان ب</a>
                                  </li>
                                  <li><a href="{{ URL::to('empplanC') }}">پلان ج</a>
                                  </li>
                              </ul>
                          </div>
                      </li>
                      <li class="bold"><a href="{{ URL::to('p2form') }}" class="collapsible-header waves-effect waves-cyan"><i class="mdi-action-description" style="font-size: 30"></i>فورم P2</a>
                      </li>
                      <li class="bold"><a href="{{ URL::to('emptybast') }}" class="collapsible-header waves-effect waves-cyan"><i class="mdi-image-camera" style="font-size: 30"></i>بست خالی</a>

                      </li>

                      <li class="li-hover"><div class="divider"></div></li>
                      <li class="li-hover"><p class="ultra-small margin more-text">کاندیدان</p></li>

                      <li class="bold"><a href="{{URL::to('listcondidate')}}" class="collapsible-header  waves-effect waves-cyan"><i class="mdi-hardware-headset-mic" style="font-size: 30"></i>لیست کاندیدان</a>

                      </li>

                      <li class="bold"><a href="{{URL::to('shortlist')}}" class="collapsible-header waves-effect waves-cyan"><i class="mdi-action-settings-voice" style="font-size: 30"></i>شارت لیس شده ها</a>

                      </li>



                      <li class="bold"><a href="{{URL::to('selection')}}" class="collapsible-header  waves-effect waves-cyan"><i class="mdi-maps-local-mall" style="font-size: 30"></i>فورم انتخابی</a>
                      <li> </li>

                      <li class="bold"><a href="{{URL::to('darkhasti')}}" class="collapsible-header waves-effect waves-cyan"><i class="mdi-notification-event-note" style="font-size: 30"></i>فورم درخواستی</a>
                      ...
                      <li class="li-hover"><div class="divider"></div></li>
                      <li class="li-hover"><p class="ultra-small margin more-text">بیشتر</p></li>



              </li>
              <li class="bold"><a href="{{URL::to('interview')}}" class="collapsible-header  waves-effect waves-cyan"><i class="mdi-action-assignment-late" style="font-size: 30"></i>فورم مصاحبه</a>

              </li>
              <li class="bold"><a href="{{URL::to('contract')}}" class="collapsible-header  waves-effect waves-cyan"><i class="mdi-communication-quick-contacts-mail" style="font-size: 30"></i>فورم قرارداد</a>

              </li>
              <li class="bold"><a href="{{URL::to('empreport')}}" class="collapsible-header  waves-effect waves-cyan"><i class="mdi-communication-quick-contacts-mail" style="font-size: 30"></i>گذارشات</a>
