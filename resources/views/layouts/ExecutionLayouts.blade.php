...
<body>
  ...
  <div id="main">
    ...
    <div class="wrapper">
      ...
      <a class="btn-flat dropdown-button waves-effect waves-light white-text profile-btn" href="#" data-activates="profile-dropdown">مدیریت اجراات<i class="mdi-navigation-arrow-drop-down right"></i></a>

                      </div> 
              </li>

              
               <li class="bold"><a href="{{ URL::to('Execution') }}" class="waves-effect waves-cyan"><i class="mdi-action-dashboard"></i> دشبورد</a>
              </li>
              

               <li class="no-padding">
                  <ul class="collapsible collapsible-accordion">
                      <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-action-invert-colors"></i>ایجاد پلان</a>
                          <div class="collapsible-body">
                              <ul>
                                  <li><a href="{{ URL::to('executionplanA') }}">پلان الف</a>
                                  </li>                                        
                                  <li><a href="{{ URL::to('executionplanB') }}">پلان ب</a>
                                  </li>
                                  <li><a href="{{ URL::to('executionplanC') }}">پلان ج</a>
                                  </li>
                              </ul>
                          </div>
                      </li>
                       ...
                       <li class="bold"><a href="{{URL::to('order')}}" class="collapsible-header  waves-effect waves-cyan"><i class="mdi-action-swap-vert-circle"></i>آجندا و فرامین</a>

                      </li>


              <li class="bold"><a href="{{ URL::to('executionreport') }}" class="collapsible-header  waves-effect waves-cyan"><i class="mdi-editor-insert-invitation"></i>گزارشات</a>
