              ...
              <li class="user-details cyan darken-2">
                  ...
                  <div class="col col s8 m8 l8">
                          <ul id="profile-dropdown" class="dropdown-content">
                            ...
                            <a class="btn-flat dropdown-button waves-effect waves-light white-text profile-btn" href="#" data-activates="profile-dropdown">مدیریت ارتباط کارکنان<i class="mdi-navigation-arrow-drop-down right"></i></a>
                          
                      </div> 
              </li>


              <li class="bold"><a href="{{ URL::to('relation') }}" class="waves-effect waves-cyan"><i class="mdi-action-dashboard"></i> دشبورد</a>
              </li>
                  ...
                  <ul class="collapsible collapsible-accordion">
                      <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-action-invert-colors"></i> پلان ها</a>
                          <div class="collapsible-body">
                              <ul>
                                  <li><a href="{{ URL::to('relationplanA') }}">پلان الف</a>
                                  </li>
                                  <li><a href="{{ URL::to('relationplanB') }}">پلان ب</a>
                                  </li>
                                  <li><a href="{{ URL::to('relationplanC') }}">پلان ج</a>
                                  </li>
                              </ul>
                          </div>
                      </li>
                      ...
                      <li class="bold"><a href="{{ URL::to('complain') }}" class="collapsible-header  waves-effect waves-cyan"><i class="mdi-image-palette"></i>شکایات</a>

                      </li>


                      <li class="bold"><a href="{{ URL::to('seminar') }}" class="collapsible-header  waves-effect waves-cyan"><i class="mdi-action-swap-vert-circle"></i>سمینار ها</a>

                      </li>

                      <li class="bold"><a href="{{ URL::to('relationreport') }}" class="collapsible-header  waves-effect waves-cyan"><i class="mdi-editor-insert-invitation"></i>گذارشات</a>
