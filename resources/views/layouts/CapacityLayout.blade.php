              ...
              <li class="user-details cyan darken-2">
                  ...
                  <div class="col col s8 m8 l8">
                          <ul id="profile-dropdown" class="dropdown-content">
                            ...
                            <a class="btn-flat dropdown-button waves-effect waves-light white-text profile-btn" href="#" data-activates="profile-dropdown">مدیریت ارتقاع ظرفیت<i class="mdi-navigation-arrow-drop-down right"></i></a>
                          
                      </div> 
              </li>

              
               <li class="bold"><a href="{{ URL::to('capacitybuilding') }}" class="waves-effect waves-cyan"><i class="mdi-action-dashboard"></i>دشبورد</a>
              </li>
                  ...
                  <ul class="collapsible collapsible-accordion">
                      <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-action-invert-colors"></i>پلان ها</a>
                          <div class="collapsible-body">
                              <ul>
                                  <li><a href="{{ URL::to('capacityplanA') }}">پلان الف</a>
                                  </li>
                                  <li><a href="{{ URL::to('capacityplanB') }}">پلان ب</a>
                                  </li>
                                  <li><a href="{{ URL::to('capacityplanC') }}">پلان ج</a>
                                  </li>
                              </ul>
                          </div>
                      </li>

                      <li class="bold"><a href="{{ URL::to('training') }}" class="collapsible-header waves-effect waves-cyan"><i class="mdi-social-pages"></i>لیست ترنینگ ها</a>
                      ...
                      <li class="bold"><a href="{{ URL::to('neyazsangi') }}" class="collapsible-header  waves-effect waves-cyan"><i class="mdi-action-swap-vert-circle"></i>نیاز سنجی</a>

                      </li>

                      <li class="bold"><a  href="{{ URL::to('education') }}" class="collapsible-header  waves-effect waves-cyan"><i class="mdi-editor-insert-chart"></i>ضروریا تحصیلی</a>

                      </li>

                      <li class="bold"><a href="{{ URL::to('capacityreport') }}" class="collapsible-header  waves-effect waves-cyan"><i class="mdi-editor-insert-invitation"></i>گذارشات</a>
