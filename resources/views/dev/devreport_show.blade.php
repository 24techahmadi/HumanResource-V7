            ...
            <div class="row">
                <div class="col s12 m12 l12">
                    <div class="card-panel">
                        ...
                        <hr>
                        <div class="row">
                            <form method="POST" action="{{ url('devreport') }}" class="col s12" >
                                {!! csrf_field() !!}
                            ...
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="card-panel">
                                        ...
                                        <hr>
                                        <div class="row">
                                            <form method="POST" action="{{ route('devreport.update',['id'=>$record]) }}" accept-charset="utf-8" class="col s11 right" data-parsley-validate>
                                                {!! csrf_field() !!}
