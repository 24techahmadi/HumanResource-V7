...
<div id="main">
    ...
    <div class="wrapper">
        ...
        @section('content')
            ...
            <div class="row">
                <form method="POST" action="{{ url('comparison') }}" class="col s12" data-parsley-validate>
                    {!! csrf_field() !!}
                        ...
                        <div class="card-panel">
                            ...
                            <div class="row">
                                ...
                                <div class="input-field col s6">
                                    ...
                                    <input name="id" disabled="disabled" type="text" data-parsley-required="true" value="{{ $record->id }}">
                                ...
                                <div class="input-field col s6">
                                    <i class="mdi-editor-merge-type prefix"></i>
                                    <input name="Title" type="text" data-parsley-required="true" value="{{ $record->Title }}">
                                    <label for="Title">عنوان</label>
                                </div>

                                <div class="input-field col s6">
                                    <i class="mdi-action-schedule prefix"></i>
                                    <input name="Year" type="text" value="{{ $record->Year }}">
                                ...
                                <div class="input-field col s6">
                                    <i class="mdi-editor-merge-type prefix"></i>
                                    <input name="Amount" type="text" data-parsley-required="true" value="{{ $record->Amount }}">
                                    <label for="Amount">تعداد</label>
                                </div>

                                <div class="input-field col s6">
                                    <i class="mdi-editor-merge-type prefix"></i>
                                    <input name="BastIncrease" type="text" data-parsley-required="true" value="{{ $record->BastIncrease }}">
                                    <label for="BastIncrease">تزیید</label>
                                </div>

                                <div class="input-field col s6">
                                    <i class="mdi-editor-merge-type prefix"></i>
                                    <input name="BastDecrease" type="text" data-parsley-required="true" value="{{ $record->BastDecrease }}">
                                    <label for="BastDecrease">تنقیص</label>
                                </div>

                                <div class="input-field col s6">
                                    <i class="mdi-action-schedule prefix"></i>
                                    <input name="RoleForYearOf" type="text" class="datepicker" value="{{ $record->RoleForYearOf }}">
                                    <label for="RoleForYearOf">طرح پیشنهادی سال</label>
                                </div>

                                <div class="input-field col s6">
                                    <i class="mdi-editor-merge-type prefix"></i>
                                    <input name="ToBast" type="text" data-parsley-required="true" value="{{ $record->ToBast }}">
                                    <label for="ToBast">بست</label>
                                </div>

                                <div class="input-field col s6">
                                    <i class="mdi-editor-merge-type prefix"></i>
                                    <input name="NewAmount" type="text" data-parsley-required="true" value="{{ $record->NewAmount }}">
                                    <label for="NewAmount">تعداد</label>
                                </div>

                                <div class="input-field col s6">
                                    <i class="mdi-editor-merge-type prefix"></i>
                                    <input name="NewCode" type="text" data-parsley-required="true" value="{{ $record->NewCode }}">
            ...
            <div id="modal2" class="col s8 m8 l12 modal" style="border-radius:25px">
                <div class="modal-content">
                    ...
                    <form method="POST" action="{{ route('comparison.update',['id'=>$record]) }}" accept-charset="utf-8" class="col s12" data-parsley-validate>
                        {!! csrf_field() !!}
                        ...
                        <div class="col s12 m12 l12">
                            <div class="card-panel">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-field col s6">
                                        <i class="mdi-action-schedule prefix"></i>
                                        <input name="RoleForYearOf" type="text" data-parsley-required="true" class="datepicker" value="{{ $record->RoleForYearOf }}">
                                        <label for="RoleForYearOf">طرح پیشنهادی سال</label>
                                    </div>
