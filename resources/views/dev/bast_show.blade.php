            ...
            <div class="row">
                <div class="col s12 m12 l12">
                    <div class="card-panel">
                        ...
                        <hr>
                        <div class="row">
                            <form method="POST" action="{{ url('bast') }}" class="col s12" >
                                {!! csrf_field() !!}
                                ...
                                <div class="row">
                                    <div class="input-field col s6">
                                        <input placeholder="Enter Bast Code Number" name="CodeNumber" type="text" data-parsley-required="true" value="{{ $record->CodeNumber }}">
                                        <label for="CodeNumber">کود نمبر</label>
                                    </div>

                                    <div class="input-field col s6">
                                        <input placeholder="Placeholder" name="Title" type="text" data-parsley-required="true" value="{{ $record->Title }}">
                                        <label for="Title">عنوان بست</label>
                                    </div>

                                    <div class="input-field col s6">
                                        <input placeholder="Placeholder" name="Type" type="text" data-parsley-required="true" value="{{ $record->Type }}">
                                        <label for="Type">نوع بست</label>
                                    </div>

                                    <div class="input-field col s6">
                                        <input placeholder="Placeholder" name="AnnouncementStartDate" type="text" class="datepicker" value="{{ $record->AnnouncementStartDate }}">
                                        <label for="AnnouncementStartDate">تاریخ اعلان بست</label>
                                    </div>

                                    <div class="input-field col s12">
                                        <input placeholder="Placeholder" name="AnnouncementEndDate" type="text" class="datepicker" value="{{ $record->AnnouncementEndDate }}">
            ...
            <div class="row">
                <div class="col s12 m12 l12">
                    <div class="card-panel">
                        ...
                        <div class="row">
                            <form method="POST" action="{{ route('bast.update',['id'=>$record]) }}" accept-charset="utf-8" class="col s11 right" data-parsley-validate>
                                {!! csrf_field() !!}
                                <input name="_method" type="hidden" value="PATCH">

                                <div class="row">
                                    <div class="input-field col s6">
                                        <input placeholder="id" name="id" type="text" data-parsley-required="true" value="{{ $record->id }}">
                                        <label for="id">آی دی</label>
                                    </div>
