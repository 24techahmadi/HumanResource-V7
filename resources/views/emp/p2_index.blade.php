...
@section('content')
            ...
            <h2 class="header" align="left">نمایش فورم های پی دو
                ...
                <div class="col s12 m8 l12">
                  <table id="data-table-simple" class="responsive-table display" cellspacing="0">
                    ...
                    @foreach($records as $record)
                        <tr>
                            <td>{{ $record->id }}</td>
                            <td>{{ $record->ExecutionNumber }}</td>
                            <td>{{ $record->Name }}</td>
                            <td>{{ $record->FatherName }}</td>
                            <td>{{ $record->EmployeeNumber }}</td>
                            <td><a href="{{url('p2form', $record->id)}}" class="waves-effect waves-light"> <i class="right mdi-action-settings prefix"></i></a> </td>
                        </tr>
                    @endforeach
