    ...
    <div class="wrapper">
        ...
        <section id="content">
            ...
            @section('content')
                ...
                <!--Input fields-->
                <form method="POST" action="{{ url('training') }}" class="col s12" data-parsley-validate>
                    {!! csrf_field() !!}
                <div class="row">
                        ...
                        <div class="card-panel">
                            ...
                            <div class="row">
                                    ...
                                    <div class="input-field col s6">
                                        ...
                                        <input name="CourseTitle" type="text" data-parsley-required="true">
                                        <label for="CourseTitle">عنوان کورس</label>
                                    </div>

                                    <div class="input-field col s6">
                                        <i class="mdi-social-person prefix"></i>
                                        <input name="Duration" type="text" data-parsley-required="true">
