            ...
            <div class="col s12 m12 l12">
              <div class="card-panel">
                ...
                <div class="input-field col s12">
                          ...
                          <h5 class="task-card-title">Expanding plan Form For Higher Education Ministry Organizatios</h5>
                          </li>
                          </ul>
                        </div>
            ...
            <i class="mdi-action-schedule prefix"></i>
              ...
              <i class="mdi-maps-place prefix"></i>
                        ...
                        <div class="input-field col s12">
                          <ul id="task-card" class="collection with-header">
                          <li class="collection-header cyan">
                          <h5 class="task-card-title">Current And New Faculays</h5>
                          </li>
                          </ul>
                        </div>
                        ...
                        <div class="input-field col s6">
              <i class="mdi-maps-place prefix"></i>
                          <input  id="Facultay Type" type="text" class="validate">
                          <label for="Facultay Type">Facultay Type(New/Current)</label>
                        </div>

                      <div class="input-field col s6">
              <i class="mdi-maps-place prefix"></i>
                          <input  id="Facultay Name" type="text" class="validate">
                          <label for="Facultay Name">Facultay Name</label>
                        </div>

                        <div class="input-field col s6">
              <i class="mdi-maps-place prefix"></i>
                          <input  id="New Dapartment" type="text" class="validate">
                          <label for="New Dapartment">New Dapartment</label>
                        </div>
