            ...
            <div class="row">
                <div class="col s12 m12 l12">
                    <div class="card-panel">
                        ...
                        <hr>
                        <div class="row">
                            <form method="POST" action="{{ url('lowerevaluation') }}" class="col s12" >
                                {!! csrf_field() !!}
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-field col s6">
                                        <i class="mdi-social-location-city prefix"></i>
                                        <input name="Moderyat" type="text" value="{{ $record->Moderyat }}" data-parsley-required="true">
                                    ...
                                    <div class="input-field col s6">
                                        <i class="mdi-social-person prefix"></i>
                                        <input name="CurrentPositionDuration" type="text" value="{{ $record->CurrentPositionDuration }}" data-parsley-required="true">
                                        <label for="CurrentPositionDuration">مدت اجرای وظیفه زیر دست آمر فعلی</label>
                                    </div>

                                    <div class="input-field col s6">
                                        <i class="mdi-editor-merge-type prefix"></i>
                                        <input name="EvaluationType" type="text" value="{{ $record->EvaluationType }}" data-parsley-required="true">
                                        <label for="EvaluationType">نوع ارزیابی</label>
                                    </div>

                                    <div class="input-field col s6">
                                        <i class="mdi-action-schedule prefix"></i>
                                        <input name="LastEvaluationDate" type="text" value="{{ $record->LastEvaluationDate }}" class="datepicker">
                                        <label for="LastEvaluationDate">تاریخ ارزیابی قبلی</label>
                                    </div>

                                    <div class="input-field col s6">
                                        <i class="mdi-action-info-outline prefix"></i>
                                        <input name="LastEvaluationResult" type="text" value="{{ $record->LastEvaluationResult }}" data-parsley-required="true">
                                    ...
                                    <div class="input-field col s6">
                                        <i class="mdi-social-person prefix"></i>
                                        <input name="GroupWork" type="text" value="{{ $record->GroupWork }}" data-parsley-required="true">
                                    ...
                                    <div class="input-field col s6">
                                        <i class="mdi-social-person prefix"></i>
                                        <input name="RecieverSatisification" type="text" value="{{ $record->RecieverSatisification }}" data-parsley-required="true">
                                    ...
                                    <div class="input-field col s6">
                                        <i class="mdi-social-person prefix"></i>
                                        <input name="TechnicalInformation" type="text" value="{{ $record->TechnicalInformation }}" data-parsley-required="true">
                                    ...
                                    <div class="input-field col s6">
                                        <i class="mdi-social-person prefix"></i>
                                        <input name="TechnicalExperts" type="text" value="{{ $record->TechnicalExperts }}" data-parsley-required="true">
                                    ...
                                    <div class="input-field col s6">
                                        <i class="mdi-social-person prefix"></i>
                                        <input name="AcomplishmentQuality" type="text" value="{{ $record->AcomplishmentQuality }}" data-parsley-required="true">
                                    ...
                                    <div class="input-field col s6">
                                        <i class="mdi-social-person prefix"></i>
                                        <input name="WorkingWithPresure" type="text" value="{{ $record->WorkingWithPresure }}" data-parsley-required="true">
                                    ...
                                    <div class="input-field col s6">
                                        <i class="mdi-social-person prefix"></i>
                                        <input name="SelfSecurity" type="text" value="{{ $record->SelfSecurity }}" data-parsley-required="true">
                                    ...
                                    <div class="input-field col s6">
                                        <i class="mdi-social-person prefix"></i>
                                        <input name="SavingOthersSecurity" type="text" value="{{ $record->SavingOthersSecurity }}" data-parsley-required="true">
                                    ...
                                    <div class="input-field col s6">
                                        <i class="mdi-social-person prefix"></i>
                                        <input name="JobAvalibility" type="text" value="{{ $record->JobAvalibility }}" data-parsley-required="true">
                                    ...
                                    <div class="input-field col s6">
                                        <i class="mdi-social-person prefix"></i>
                                        <input name="BehaviorRole" type="text" value="{{ $record->BehaviorRole }}" data-parsley-required="true">
                                    ...
                                    <div class="input-field col s6">
                                        <i class="mdi-social-group prefix"></i>
                                        <input name="DirectManagerScore" type="text" value="{{ $record->DirectManagerScore }}" data-parsley-required="true">
                                    ...
                                    <div class="input-field col s6">
                                        <i class="mdi-action-info-outline prefix"></i>
                                        <input name="EvaluatoreComment" type="text" value="{{ $record->EvaluatoreComment }}" data-parsley-required="true">
                ...
                <div id="modal2" class="modal" style="border-radius:25px">
                    <div class="modal-content">
                        <div class="card-panel cyan darken-1" align="right">
                        ...
                        <div class="row">
                            <div class="col s12 m12 l12">
                                <div class="card-panel">
                                    <h4 class="header2" align="right"><b>معلو مات سطر</b></h4>
                                    ...
                                    <hr>
                                    <div class="row">
                                        <form method="POST" action="{{ route('lowerevaluation.update',['id'=>$record]) }}" accept-charset="utf-8" class="col s11 right" data-parsley-validate>
                                            {!! csrf_field() !!}
