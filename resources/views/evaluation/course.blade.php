  ...
  <div id="main">
    ...
    <div class="wrapper">
      ...
      <section id="content">
        ...
        <!--breadcrumbs end-->
          @section('content')
         <h1 class="header" align="right">کورس ها</h1>
              ...
              <div class="card-panel">
                ...
                <div class="row">
                      ...
                      <div class="input-field col s6">
                          ...
                          <input id="strdate" type="date" class="datepicker">
                          <label for="strdate">تاریخ شروع</label>
                        </div>

                        <div class="input-field col s6">
                          <i class="mdi-action-schedule prefix"></i>
                          <input id="endate" type="date" class="datepicker">
                          <label for="endate">تاریخ ختم</label>
                        </div>
