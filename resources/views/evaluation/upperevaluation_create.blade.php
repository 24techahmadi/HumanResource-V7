            ...
            <div class="container">
                <div class="row">
                    <div class="col s12 m12 l12" align="right">
                        <h5 class="breadcrumbs-title">مدیر یت ارزیابی</h5>
                        <ol class="breadcrumb">
            ...
            <div class="row">
                <div class="col s12 m12 l12">
                    <div class="card-panel">
                        ...
                        <hr>
                        <div class="row">
                            <form method="POST" action="{{ url('upperevaluation') }}" class="col s12" data-parsley-validate>
                                {!! csrf_field() !!}
                                ...
                                <div class="row" >
                                    ...
                                    <div class="input-field col s6">
                                        ...
                                        <input name="EucationField" type="text" data-parsley-required="true">
                                    ...
                                    <div class="input-field col s6">
                                        <i class="mdi-action-schedule prefix"></i>
                                        <input name="PrimaryRegDate" type="text" class="datepicker">
                                        <label for="PrimaryRegDate">تاریخ تقرر ابتدایی</label>
                                    </div>

                                    <div class="input-field col s6">
                                        <i class="mdi-action-schedule prefix"></i>
                                        <input name="CompetitionRegDate" type="text" class="datepicker">
                                        <label for="CompetitionRegDate">تاریخ تقرر از طریق رقابت</label>
                                    </div>

                                    <div class="input-field col s6">
                                        <i class="mdi-maps-directions-walk prefix"></i>
                                        <input name="Jobrelatedtranings" type="text" data-parsley-required="true">
                                    ...
                                    <div class="input-field col s6">
                                        <i class="mdi-maps-place prefix"></i>
                                        <input name="Reysat" type="text" data-parsley-required="true">
                                        <label for="Reysat">ریاست</label>
                                    </div>

                                    <div class="input-field col s6">
                                        <i class="mdi-maps-place prefix"></i>
                                        <input name="Moderiat" type="text" data-parsley-required="true">
                                    ...
                                    <div class="input-field col s6">
                                        ...
                                        <input name="QadamPayment" type="text" data-parsley-required="true">
                                        <label for="QadamPayment">مزد قدم بست به افغانی</label>
                                    </div>

                                    <div class="input-field col s6">
                                        <i class="mdi-action-info-outline prefix"></i>
                                        <input name="OtherPayment" type="text" data-parsley-required="true">
                                    ...
                                    <div class="input-field col s6">
                                        <i class="mdi-action-info-outline prefix"></i>
                                        <input name="SalaryTotal" type="text" data-parsley-required="true">
                                        <label for="SalaryTotal">مجموع مزد و امتیازات به افغانی</label>
                                    </div>

                                    <div class="input-field col s6">
                                        <i class="mdi-action-info-outline prefix"></i>
                                        <input name="Responsibility" type="text" data-parsley-required="true">
                                        <label for="Responsibility">وظایف بست طبق لایحه</label>
                                    </div>

                                    <div class="input-field col s6">
                                        <i class="mdi-editor-merge-type prefix"></i>
                                        <input name="AccomplishmentType" type="text" data-parsley-required="true">
                                    ...
                                    <div class="input-field col s6">
                                        <i class="mdi-action-info-outline prefix"></i>
                                        <input name="WorkPlane" type="text" data-parsley-required="true">
                                    ...
                                    <div class="input-field col s6">
                                        <i class="mdi-action-receipt prefix"></i>
                                        <input name="AnnualAccomplishmentType" type="text" data-parsley-required="true">
                                        <label for="AnnualAccomplishmentType">چگونگی اجرات انجام شده طبق راپور سالانه</label>
                                    </div>

                                    <div class="input-field col s6">
                                        <i class="mdi-action-receipt prefix"></i>
                                        <input name="AnAccomplishmentResons" type="text" data-parsley-required="true">
                                    ...
                                    <div class="input-field col s12" align="right">
                                        <ul id="task-card" class="collection with-header">
                                            ...
                                            <div class="input-field col s6">
                                                <i class="mdi-social-person prefix"></i>
                                                <input name="OfficialName" type="text" data-parsley-required="true">
                                                <label for="OfficialName">اسم</label>
                                            </div>
                                            <div class="input-field col s6">
                                                <i class="mdi-action-schedule prefix"></i>
                                                <input name="OfficialDate" type="text" class="datepicker">
                                    ...
                                    <div class="input-field col s12" align="right">
                                        <ul id="DirecteManagerAcceptance" class="collection with-header">
                                            ...
                                            <li>
                                                ...
                                                <div class="input-field col s6">
                                                    <i class="mdi-social-person prefix"></i>
                                                    <input name="HeadManagerName" type="text" data-parsley-required="true">
                                    ...
                                    <div class="input-field col s6">
                                        <i class="mdi-social-person prefix"></i>
                                        <input name="OfficialName2" type="text" data-parsley-required="true">
                                        <label for="OfficialName2">نمره پلان کار سالانه</label>
                                    </div>

                                    <div class="input-field col s6">
                                        <i class="mdi-social-person prefix"></i>
                                        <input name="OfficialName3" type="text" data-parsley-required="true">
                                        <label for="OfficialName3">نمره معیارهای اضافی</label>
                                    </div>

                                    <div class="input-field col s6">
                                        <i class="mdi-social-person prefix"></i>
                                        <input name="OfficialName4" type="text" data-parsley-required="true">
                                    ...
                                    <div class="input-field col s12" align="right">
                                        <ul id="DirecteManagerAcceptance" class="collection with-header">
                                            ...
                                            <li>
                                                ...
                                                <div class="input-field col s6">
                                                    <i class="mdi-social-person prefix"></i>
                                                    <input name="HeadManagerName1" type="text" data-parsley-required="true">
                                                    <label for="HeadManagerName1">اسم آمر مستقیم</label>
                                                </div>

                                                <div class="input-field col s6">
                                                    <i class="mdi-social-person prefix"></i>
                                                    <input name="HeadManagerName2" type="text" data-parsley-required="true">
