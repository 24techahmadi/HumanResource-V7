        ...
        @section('content')
            <section>
                <h3 class="header">گزارش سالان
                    <a href="{{ url('evaluationreport/create') }}" class="tooltipped btn-floating  btn-large waves-effect waves-light right" tooltipped data-position="bottom" data-delay="50" data-tooltip="NewRecord"><i class="mdi-content-add"></i></a>
                            ...
                            <table id="data-table-simple" class="responsive-table display" cellspacing="0">
                                ...
                                @foreach($records as $record)
                                    <tr>
                                        ...
                                        <td><a href="{{url('evaluationreport', $record->id)}}" class="waves-effect waves-light"> <i class="right mdi-action-settings prefix"></i></a> </td>
                                    </tr>
                                @endforeach
